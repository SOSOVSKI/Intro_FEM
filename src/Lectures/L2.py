...
#%% --- Helper Functions (Choose based on previous preference) ---

# Option 1: Use HTML for styled print
def print_styled(text, size="1.1em"):
    display(HTML(f"<div style='margin: 5px 0; font-size: {size};'>{text}</div>"))

# Option 2: Use Markdown for text flow
# def print_styled(text, size=None): # size argument ignored here
