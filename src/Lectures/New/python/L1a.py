...
# %%
# NOTE: The interactive ipywidgets slider has been removed here because
# it runs at import time and hangs Quarto's PDF kernel (no widget frontend).
# The convergence demo is now handled inline in ch01-introduction.qmd.
# %%
